...
>
> **标注约定**：【已验证】= 实测过；【高可能】= 资料/社区一致但未实测；【待验证】= 必须实测后才能下结论；未实测不得标已验证。
>


> **文案约定**：方括号一律全角【】；cmd 括号块内 echo 文本禁用半角圆括号（半角 ) 会提前闭块）。
