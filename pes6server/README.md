...
*微信收款码：将 `weixin_qrcode.png` 放在本 README 同目录即可显示（图片文件不入仓库）*
...
| 2026-09-07 14:15 | 第 12 章重写为面向使用者的路线图(移除全部内部过程记录/AI 痕迹/真实账号名)；排障条目去真实账号名；账号示例改 player1；提交身份行脱敏；收款码图片不入仓库
